...
def load_model(model_choice):
    ...
    if model_choice == "ResNet50":
        ...
        backbone = models.efficientnet_b0(weights=None)  # adjust b0/b3/etc. depending on training
...
st.write("Upload an image and choose a model to predict surface type and quality.")
